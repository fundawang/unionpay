...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '/var/www/html/upacp_sdk_php/700000000000001_acp.pfx';

// 签名证书密码
 const SDK_SIGN_CERT_PWD = '000000';

// 密码加密证书（这条用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = '/var/www/html/upacp_sdk_php/verify_sign_acp.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = '/var/www/html/upacp_sdk_php/';
...
//文件下载目录 
const SDK_FILE_DOWN_PATH = '/var/tmp';

//日志 目录 
const SDK_LOG_FILE_PATH = '/var/tmp';
